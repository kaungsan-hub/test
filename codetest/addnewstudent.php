...
<html lang="en">
	...
	<?php
		...
		$result = mysqli_query($connect, "INSERT INTO `student`(`nric`,`firstname`,`lastname`,`gender`,`dateofbirth`,`email`)
			VALUES ( '$nric', '$fname', '$lname', '$gender', '$dob', '$email')");
	...
	?>
			...
			<form action="" method="post">
				<table>
					...
					<tr>
						<td>NRIC/FIN:</td>
						<td><input type="text" name="nric" required="required"><span class="errmsg"></span></td>
						<td></td>
					</tr>
					<tr>
						<td>First Name:</td>
						<td><input type="text" name="fname" required="required"><span class="errmsg"></span></td>
						<td></td>
					</tr>
					<tr>
						<td>Last Name:</td>
